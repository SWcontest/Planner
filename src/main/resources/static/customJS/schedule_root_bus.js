// // 대중교통
// export default function searchBusLaneAJAX(slat, slng, elat, elng) {
//
//     let xhr = new XMLHttpRequest();
//
//     let url = `https://api.odsay.com/v1/api/searchPubTransPath?SX=${slat}&SY=${slng}&EX=${elat}&EY=${elng}&OPT=1&apiKey=xzm+dv1+LZESXRkacw+Wot/SwZU38z9Ubd7tPsAt1eg`;
//
